...
@section('page_name', ' صورت حساب مالی عامل ')
    ...
    <div class="white-box">
        <div class="portlet-body">
            ...
            <form class="filter_list" method="get" style="direction: rtl">
                ...
                <div class="col-md-3 col-xs-12">
                    <div class="form-group">
                        <label for="filter_user">نام عامل</label>
                    ...
                    @foreach($request as $k => $item)
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                ...
                                {{--<div class="col-xs-6">
                                    <a class="btn btn-block btn-info btn-rounded" target="_blank" href="{{ url('cp-manager/bill/amel/edit/' . $item['order_id']) }}"> ویرایش </a>
                                </div>--}}
