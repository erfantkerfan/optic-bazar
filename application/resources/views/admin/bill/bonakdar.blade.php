...
@section('page_name', ' صورت حساب مالی بنکداران ')
    ...
    <div class="white-box">
        <div class="portlet-body">
            ...
            <form class="filter_list" method="get" style="direction: rtl">
                ...
                <div class="col-md-3 col-xs-12">
                    <div class="form-group">
                        <label for="filter_user">نام بنکدار</label>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($request as $k => $item)
                        <?php $seller = App\User::where('id' , $item['seller'])->first() ?>
                        <tr role="row" class="filter">
                            ...
                            <td>
                                ...
                                {{--<div class="col-xs-6">
                                    <a class="btn btn-block btn-info btn-rounded" target="_blank" href="{{ url('cp-manager/bill/bonakdar/edit/' . $item['order_id']) }}"> ویرایش </a>
                                </div>--}}
