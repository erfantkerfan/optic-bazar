...
@section('page_name', 'ویرایش اسلاید')
        ...
        <form method="post" action="" style="direction: rtl">
                ...
                <div class="col-md-9">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="{{ (old('video', $request->video)) ? '' : 'active' }}"><a href="#image" aria-controls="image" role="tab" data-toggle="tab">تصویر</a></li>
                            <li role="presentation" class="{{ (old('video', $request->video)) ? 'active' : '' }}"><a href="#video" aria-controls="video" role="tab" data-toggle="tab">ویدیو</a></li>
                        </ul>

                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane {{ (old('video', $request->video)) ? '' : 'active' }}" id="image">
                            ...
                            <div role="tabpanel" class="tab-pane {{ (old('video', $request->video)) ? 'active' : '' }}" id="video">
                                        ...
                                        <div class="bac_upload_video">
                                            <span class="btn btn-xs fileinput-button btn-success">
                                                ...
                                                <span style="display: none;" id="gallery_results_wrapper">
                                                    @if(old('video', $request->video))
                                                        <input type="hidden" name="gallery[]" value="{{ old('video', $request->video) }}">
                                                    @endif
                                                </span>
                                            </span>
            ...
            <div class="form-group row mb-0">
                <div class="col-md-9 offset-md-4">
                    <button type="submit" class="btn btn-info waves-effect waves-light">ویرایش اسلاید</button>
                </div>
            </div>
            <div class="clearfix"></div>
        </form>
