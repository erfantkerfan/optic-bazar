                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($request as $k => $item)
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <div class="col-xs-6">
                                    <a class="btn btn-block btn-info btn-rounded request_but" href="{{ url('cp-manager/product/edit_optical_glass/' . $item['product_id']) }}"> ویرایش </a>
                                </div>
                                <div class="col-xs-6">
                                    <a class="btn btn-block btn-danger btn-rounded delete-warning" href="{{ url('cp-manager/product/delete/' . $item['product_id']) }}"> حذف </a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
