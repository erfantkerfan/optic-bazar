    ...
    <div class="white-box">
        ...
        <form method="post" action="" style="direction: rtl">
                ...
                <div class="col-md-9">
                    ...
                    <div class="slime_uploadfile" style="width: 25%; margin: 0 auto">
                        <div class="slim"
                            ...
                            @if(old('logo') && !file_exists(old('logo')))
                                <img class="imslider" src="{{ url(old('logo')) }}" alt=""/>
                            @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input id="profit" type="number" min="0" max="100" class="form-control{{ $errors->has('profit') ? ' is-invalid' : '' }}" name="profit" value="{{ old('profit') }}">
