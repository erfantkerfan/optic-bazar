            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select id="location" class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" name="location">
                        ...
                        <option value="home" {{ (old('location') == 'home') ? 'selected' : '' }}>نمایش در صفحه اصلی</option>
                        <option value="menu_top" {{ (old('location') == 'menu_top') ? 'selected' : '' }}>نمایش در منو</option>
                    </select>
