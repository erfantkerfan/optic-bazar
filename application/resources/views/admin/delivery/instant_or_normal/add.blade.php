...
@section('page_name', 'افزودن تحویل فوری یا عادی')
    ...
    <div class="white-box">
        ...
        <form method="post" action="" class="avatar" style="direction: rtl">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input id="time_difference_delivery_without_shaving" type="text" class="form-control{{ $errors->has('time_difference_delivery_without_shaving') ? ' is-invalid' : '' }}" name="time_difference_delivery_without_shaving" value="{{ old('time_difference_delivery_without_shaving') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input id="time_difference_delivery_with_shaving" type="text" class="form-control{{ $errors->has('time_difference_delivery_with_shaving') ? ' is-invalid' : '' }}" name="time_difference_delivery_with_shaving" value="{{ old('time_difference_delivery_with_shaving') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input id="difference_delivery" type="text" class="form-control{{ $errors->has('difference_delivery') ? ' is-invalid' : '' }}" name="difference_delivery" value="{{ old('difference_delivery') }}">
