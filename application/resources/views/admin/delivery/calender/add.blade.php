...
@section('page_name', 'افزودن تحویل تقویمی')
    ...
    <div class="white-box">
        ...
        <form method="post" action="" class="avatar" style="direction: rtl">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input id="capacity" type="text" class="form-control{{ $errors->has('capacity') ? ' is-invalid' : '' }}" name="capacity" value="{{ old('capacity') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input id="difference_receive" type="text" class="form-control{{ $errors->has('difference_receive') ? ' is-invalid' : '' }}" name="difference_receive" value="{{ old('difference_receive') }}">
