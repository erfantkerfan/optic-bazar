...
@section('content')
    ...
    <div class="white-box">
        ...
        <form method="post" action="" style="direction: rtl">
            ...
            <div class="form-group row stock">
                <label for="photocrophy" class="col-md-4 col-form-label text-md-right"> فوتوکروم </label>
            ...
            <div class="form-group row stock">
                <label for="photo_color" class="col-md-4 col-form-label text-md-right"> رنگ فوتو</label>
