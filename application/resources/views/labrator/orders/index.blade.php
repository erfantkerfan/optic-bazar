                            ...
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse"
                                   ...
                                   aria-controls="collapse<?php echo $key; ?>">
                                    ...
                                    <span class="item_head"><span>وضعیت :</span>ارسال به لابراتور</span>
                            ...
                            <div class="panel-body" style="padding: 0;">
                                ...
                                <div class="zm_step_box active">
                                    <div class="main_step">
                                                            ...
                                                            <div class="col-xs-12">
                                                                <div class="full_data_prescription">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="item_full">
                                                                            <div class="col-xs-4">خدمات مورد نباز</div>
                                                                            <div class="col-xs-8">
                                        ...
                                        <div class="col-xs-12"><a class="btn btn-block btn-info btn-rounded" target="_blank" href="{{ url('cp-labrator/order/print/' . $item['key']) }}">چاپ فاکتور</a></div>
                                        <div class="clearfix"></div>
