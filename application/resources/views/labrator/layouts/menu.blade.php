<ul class="nav" id="side-menu">
    <li><a href="{{ url('cp-labrator') }}" class="waves-effect"><i class="icon-handbag" data-icon="v"></i> <span class="hide-menu"> سفارشات </span> </a></li>
    <li><a href="{{ url('cp-labrator/bill') }}" class="waves-effect"><i class="icon-docs" data-icon="v"></i> <span class="hide-menu"> صورت حساب مالی </span> </a></li>
