...
class ProductController extends ProductSmartController
{
    ...
    public function productsLens(){
        ...
        // Return View
        return view('bonakdar/products/lens', ['request' => $request]);
    ...
    public function productEditLens(){
        ...
        //check user validate
        $request = Product::where('id' , $id)->where('seller_id' , $userLogin->id)->orderBy('id', 'desc')->first();
        ...
        return view('bonakdar/products/edit_lens', ['request' => $request , 'detail' => $details, 'axises' => $axis , 'prices' => $prices , 'bonakdars' => $bonakdars , 'brands' => $brands ,
    ...
    public function ActionProductEditLens(){
        ...
        $request->seller_id = $userLogin->id;
        $request->brand_id = $ValidData['brand'];
        $request->country = $ValidData['country'];
        $request->status = 'inactive';
        $request->gallery = json_encode($this->request->get('gallery'));
        ...
        if($request->save()){
            ...
            return redirect('cp-bonakdar/products/lens')->with('success' ,  'اطلاعات بروز رسانی شد.')->withInput();

        }else{
            return redirect('cp-bonakdar/products/lens')->with('error' ,  'خطا در ذخیره سازی اطلاعات.');
        }
    ...
    public function productAddLens(){
        ...
        return view('bonakdar/products/add_lens', ['bonakdars' => $bonakdars , 'brands' => $brands, 'axises' => $axis ,
            'country' => $country, 'group' => $group, 'diagonals' => $diagonals, 'astigmatisms' => $astigmatisms, 'structures' => $structures, 'curvatures' => $curvatures, 'colors' => $colors, 'numbers' => $numbers, 'consumption_period' => $consumption_period]);
    ...
    public function ActionProductAddLens(){
        ...
        $newProduct->seller_id = $userLogin->id;
    ...
    public function productsOpticalGlass(){
        ...
        // Return View
        return view('bonakdar/products/optical_glass', ['request' => $request]);
    ...
    public function productEditOpticalGlass(){
        ...
        return view('bonakdar/products/edit_optical_glass', ['request' => $request , 'detail' => $details , 'prices' => $prices , 'bonakdars' => $bonakdars , 'brands' => $brands ,
    ...
    public function ActionProductEditOpticalGlass(){
        ...
        if($request->save()){
            ...
            return redirect('cp-bonakdar/products/optical-glass')->with('success' ,  'اطلاعات بروز رسانی شد.')->withInput();

        }else{
            return redirect('cp-bonakdar/products/optical-glass')->with('error' ,  'خطا در ذخیره سازی اطلاعات.');
        }
    ...
    public function productAddOpticalGlass(){
        ...
        return view('bonakdar/products/add_optical_glass', ['bonakdars' => $bonakdars , 'brands' => $brands ,
